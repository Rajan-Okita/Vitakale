package com.example.vitakale.ml;
...
public final class ProjectModel {
  ...
  private ProjectModel(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    model = Model.createModel(context, "projectModel.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static ProjectModel newInstance(@NonNull Context context) throws IOException {
    return new ProjectModel(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static ProjectModel newInstance(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    return new ProjectModel(context, options);
  }
